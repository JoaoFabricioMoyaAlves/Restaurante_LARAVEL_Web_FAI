...
--
-- Host: 127.0.0.1
-- Tempo de geração: 31/10/2025 às 00:44
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_pratos_insert` (IN `p_descricao` VARCHAR(30), IN `p_valor_unitario` DOUBLE)   BEGIN
    ...
    -- Retorna o código recém-criado
    SELECT LAST_INSERT_ID() AS cod_prato;
END$$
...
(0, 'Cliente de Balcão', '16161616', '6161616161616', '875459654356', 'não tem', 'oakmdkamcacao@fai.com.br\r\n'),
...
('1qzmWypbPIWMU2drixpflSMIpq195xnbh21twnfR', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '', 1761867675);
